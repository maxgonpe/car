...
# Cliente actual de prueba (luego lo haremos dinámico)


DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        # Los valores vienen del entorno que pasaremos al `docker run`
        'NAME': os.environ.get('DB_NAME', 'netgogo_talleres'),
...
#    'default': {
#        'ENGINE': 'django.db.backends.postgresql',
#        'NAME': 'netgogo_talleres',
#        'USER': 'maxgonpe',
#        'PASSWORD': 'celsa1961',
#        'HOST': 'postgres_talleres',
#        'PORT': '5432',
#    }
#}
